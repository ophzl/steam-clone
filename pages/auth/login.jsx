        ...
        <div className="w-full h-100">
          ...
          <form className="mt-6" action="#" method="POST">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-10 hover:bg-opacity-5 focus:bg-opacity-0 mt-2 border border-black text-yellow-500 focus:border-yellow-500 focus:bg-black focus:outline-none transition duration-300"
                autoFocus
            ...
            <div className="text-right mt-2">
              <a
                href="#"
                className="text-sm font-semibold text-gray-200 hover:text-yellow-700 focus:text-yellow-700"
              >
                Forgot Password?
              </a>
            </div>
          ...
          <p className="mt-8 text-gray-300">
            ...
            <Link href="/auth/register">
              <a className="text-yellow-500 hover:text-yellow-700 font-semibold transition duration-300">
                Create an account
              </a>
            </Link>
          </p>
